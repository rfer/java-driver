...
public class MapperKeyspaceTest extends CCMTestsSupport {
    ...
    public void onTestContextInitialized() {
        execute(
                ...
                "CREATE TABLE IF NOT EXISTS MapperKeyspaceTest.user(name text PRIMARY KEY, address address)",
                ...
                "CREATE TABLE IF NOT EXISTS MapperKeyspaceTest2.user(name text PRIMARY KEY, address address)"
        );
    }
